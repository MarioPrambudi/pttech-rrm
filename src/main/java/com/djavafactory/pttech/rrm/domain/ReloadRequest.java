...
public class ReloadRequest {
	...
	/**
	  ...
	  */
	public static List<ReloadRequest> findReloadRequestsByRequestedTimeBetweenAndStatus(Date minRequestedTime,
			Date maxRequestedTime, List<String> listStatus) throws ParseException {
		String query = "SELECT ReloadRequest " + "FROM ReloadRequest reloadrequest "
	...
	*/
	public static List<ReloadRequest> findSummaryReloadRequestsByRequestedTimeBetweenAndStatus(Date minRequestedTime,
			Date maxRequestedTime, List<String> listStatus) throws ParseException {

		List<ReloadRequest> listRR = findReloadRequestsByRequestedTimeBetweenAndStatus(minRequestedTime, maxRequestedTime,
				listStatus);
