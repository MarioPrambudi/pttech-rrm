...
public class FirmwareDetailsActivity extends FirmwareDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<FirmwareProxy> view;

    private AcceptsOneWidget display;

    public FirmwareDetailsActivity(EntityProxyId<com.djavafactory.pttech.rrm.client.managed.request.FirmwareProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<com.djavafactory.pttech.rrm.client.managed.request.FirmwareProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.firmwareRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(FirmwareProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((FirmwareProxy) proxy);
