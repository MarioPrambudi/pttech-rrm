...
public abstract class ReloadRequestMobileListView_Roo_Gwt extends MobileProxyListView<ReloadRequestProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ReloadRequestMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<com.djavafactory.pttech.rrm.client.managed.request.ReloadRequestProxy> renderer) {
