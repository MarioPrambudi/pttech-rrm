...
public abstract class ReloadRequestMobileEditView_Roo_Gwt extends Composite implements View<ReloadRequestMobileEditView> {
    ...
    @UiField
    BigDecimalBox reloadAmount;

    @UiField
    TextBox serviceProviderId;

    @UiField
    IntegerBox transCode;

    @UiField
    DateBox requestedTime;
