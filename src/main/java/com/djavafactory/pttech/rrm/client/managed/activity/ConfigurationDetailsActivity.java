...
public class ConfigurationDetailsActivity extends ConfigurationDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<ConfigurationProxy> view;

    private AcceptsOneWidget display;

    public ConfigurationDetailsActivity(EntityProxyId<com.djavafactory.pttech.rrm.client.managed.request.ConfigurationProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<com.djavafactory.pttech.rrm.client.managed.request.ConfigurationProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.configurationRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(ConfigurationProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((ConfigurationProxy) proxy);
