...
public class TerminalDetailsActivity extends TerminalDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<TerminalProxy> view;

    private AcceptsOneWidget display;

    public TerminalDetailsActivity(EntityProxyId<com.djavafactory.pttech.rrm.client.managed.request.TerminalProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<com.djavafactory.pttech.rrm.client.managed.request.TerminalProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.terminalRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(TerminalProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((TerminalProxy) proxy);
