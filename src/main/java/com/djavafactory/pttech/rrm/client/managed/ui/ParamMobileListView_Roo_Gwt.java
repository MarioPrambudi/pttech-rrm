...
public abstract class ParamMobileListView_Roo_Gwt extends MobileProxyListView<ParamProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ParamMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<com.djavafactory.pttech.rrm.client.managed.request.ParamProxy> renderer) {
