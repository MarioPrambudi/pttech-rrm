...
public abstract class FirmwareMobileListView_Roo_Gwt extends MobileProxyListView<FirmwareProxy> {

    protected Set<String> paths = new HashSet<String>();

    public FirmwareMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<com.djavafactory.pttech.rrm.client.managed.request.FirmwareProxy> renderer) {
