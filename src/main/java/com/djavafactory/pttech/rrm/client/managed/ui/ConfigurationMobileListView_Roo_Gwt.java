...
public abstract class ConfigurationMobileListView_Roo_Gwt extends MobileProxyListView<ConfigurationProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ConfigurationMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<com.djavafactory.pttech.rrm.client.managed.request.ConfigurationProxy> renderer) {
