...
public abstract class ParamEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends com.djavafactory.pttech.rrm.client.scaffold.place.ProxyEditView<com.djavafactory.pttech.rrm.client.managed.request.ParamProxy, V>> extends ProxyEditView<ParamProxy, V> {
    }
}
