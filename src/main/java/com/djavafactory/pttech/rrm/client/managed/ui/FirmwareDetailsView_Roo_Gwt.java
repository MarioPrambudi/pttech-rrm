...
public abstract class FirmwareDetailsView_Roo_Gwt extends Composite implements ProxyDetailsView<FirmwareProxy> {
    ...
    public void setValue(FirmwareProxy proxy) {
        ...
        displayRenderer.setInnerText(com.djavafactory.pttech.rrm.client.managed.ui.FirmwareProxyRenderer.instance().render(proxy));
    }
}
