...
public class FirmwareMobileListView extends FirmwareMobileListView_Roo_Gwt {

    private static com.djavafactory.pttech.rrm.client.managed.ui.FirmwareMobileListView instance;

    public FirmwareMobileListView() {
        super("New Firmware", new CellRenderer());
        init();
    }

    public static com.djavafactory.pttech.rrm.client.managed.ui.FirmwareMobileListView instance() {
        if (instance == null) {
            instance = new FirmwareMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<FirmwareProxy> {
        ...
        @Override
        public SafeHtml render(FirmwareProxy value) {
            if (value == null) {
            ...
            if (value.getFirmwareFile() != null) {
                sb.appendEscaped(secondaryRenderer.render(value.getFirmwareFile()));
            }
