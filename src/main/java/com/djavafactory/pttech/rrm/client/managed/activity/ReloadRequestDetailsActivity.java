...
public class ReloadRequestDetailsActivity extends ReloadRequestDetailsActivity_Roo_Gwt {

    private final PlaceController placeController;

    private final ProxyDetailsView<ReloadRequestProxy> view;

    private AcceptsOneWidget display;

    public ReloadRequestDetailsActivity(EntityProxyId<com.djavafactory.pttech.rrm.client.managed.request.ReloadRequestProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<com.djavafactory.pttech.rrm.client.managed.request.ReloadRequestProxy> view) {
    ...
    public void deleteClicked() {
        ...
        requests.reloadRequestRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(ReloadRequestProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((ReloadRequestProxy) proxy);
